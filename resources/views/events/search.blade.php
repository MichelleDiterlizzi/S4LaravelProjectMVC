...
@section('title', 'Buscador de Eventos')
@section('content')

<div class="flex flex-col items-start justify-center bg-white  gap-5 p-10 ml-10">

    @if($events->isNotEmpty())
    <h1 class="mb-6">Resultados para: {{ $query }}</h1>
    ...
    @else
        <p class="w-full text-center">No se han encontrado eventos para: {{ $query }}</p>
    @endif

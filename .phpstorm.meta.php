...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\FullStack_Specialization_Projects\EventOrganizerLaravel\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\FullStack_Specialization_Projects\\EventOrganizerLaravel\\public\\storage',
...
'sanctum.csrf-cookie','index','register.create',
'register.store','login','login.authenticate','events.create','events.store',
'logout','profile.edit','profile.update','Profile.show','profile.destroy',
'storage.local',);
        registerArgumentsSet('views', 
'auth.login','events.create','index','layouts.user','profile.edit',
'profile.show','register.create','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
